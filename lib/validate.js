 ...
 *  
 * @todo   Instead of having factory, just export the validator and provide utilities to set its options 
 * @todo   Does it make sense for these rules to be configurable by the user? 
