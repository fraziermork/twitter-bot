...
const apiKeys     = require(__dirname + '/../config/test-config1.js');
...
require(__dirname + '/bout-handlers.js')(TwitterBot); //attach methods to handle tweeting, calling initialize, stop, and other methods on bots
