...
TwitterBot.prototype._updateStreamingApiRouter = function(){
  ...
  Object.keys(this.bots.searchBots).forEach((currentSearchBotName) => {
    ...
    if(!(currentSearchBot instanceof Object) || !currentSearchBot._running){ //the only strings that get attached to the router are those from bots that are running
...
TwitterBot.prototype._handleStreamingTweetEvent = function(tweet) {
  ...
  console.log(tweet.text.includes('backwards'));
  console.log('_____________________________________________________________________');
