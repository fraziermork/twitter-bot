...
function configureTwitterBot(apiKeys, configOptions = {}) {
  ...
  */
  ...
  function TwitterBot(options = {}) {
    ...
    this.ruleManager  = new RuleManager(this.rules);
  ...
  TwitterBot.prototype.defineRule     = defineRule;
  ...
  */
  ...
  function defineRule(...args) {
    ruleProvider.define(...args);
    return this;
  }
